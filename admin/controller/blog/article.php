...
class ControllerBlogArticle extends Controller {
	...
	protected function getList() {
        ...
        $data['setting'] = $this->url->link('blog/setting', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['add'] = $this->url->link('blog/article/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['copy'] = $this->url->link('blog/article/copy', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('blog/article/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['articles'][] = array(
				...
				'edit'       => $this->url->link('blog/article/edit', 'token=' . $this->session->data['token'] . '&article_id=' . $result['article_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('blog/article', 'token=' . $this->session->data['token'] . '&sort=pd.name' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('blog/article', 'token=' . $this->session->data['token'] . '&sort=p.status' . $url, 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['article_id'])) {
			$data['action'] = $this->url->link('blog/article/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('blog/article/edit', 'token=' . $this->session->data['token'] . '&article_id=' . $this->request->get['article_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('blog/article', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		if (isset($this->request->post['template_title'])) {
			...
			$data['template_title'] = $article_info['template_title'];
		} else {
			$data['template_title'] = '';
		}
		...
		if (isset($this->request->post['template_description'])) {
			...
			$data['template_description'] = $article_info['template_description'];
		} else {
		...
		if (isset($this->request->post['template_h1'])) {
			...
			$data['template_h1'] = $article_info['template_h1'];
		} else {
			$data['template_h1'] = '';
		}
