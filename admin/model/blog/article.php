...
class ModelBlogArticle extends Model {
    ...
    public function addArticle($data) {
        ...
        $this->db->query("INSERT INTO " . DB_PREFIX . "easy_blog_article SET sort_order = '" . (int)$data['sort_order'] . "', template_title = '" . $this->db->escape($data['template_title']) . "', template_description = '" . $this->db->escape($data['template_description']) . "', template_h1 = '" . $this->db->escape($data['template_h1']) . "', h1 = '" . $this->db->escape($data['h1']) . "', status = '" . (int)$data['status'] . "', date_modified = NOW()");
	...
	public function editArticle($article_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "easy_blog_article SET sort_order = '" . (int)$data['sort_order'] . "', template_title = '" . $this->db->escape($data['template_title']) . "', template_description = '" . $this->db->escape($data['template_description']) . "', template_h1 = '" . $this->db->escape($data['template_h1']) . "', h1 = '" . $this->db->escape($data['h1']) . "', status = '" . (int)$data['status'] . "', date_modified = NOW() WHERE article_id = '" . (int)$article_id . "'");
