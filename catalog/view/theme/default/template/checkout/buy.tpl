    ...
    <div class="row"><?php echo $column_left; ?>
        ...
        <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
            ...
            <form action="<?php echo $action; ?>" id='buy-form' method="post" enctype="multipart/form-data">
                <div class="" id='buy-load'>
                    <table class="table hidden-xs" >
                        <thead>
                            <tr>
                                <td class="cart-tble-item cart-item-img"><?php echo $column_image; ?></td>
                                <td class="cart-tble-item cart-item-name"><?php echo $column_name; ?></td>
                                <!--<td class="text-left"><?php echo $column_model; ?></td>-->
                                <td class="cart-tble-item cart-item-qua"><?php echo $column_quantity; ?></td>
                                <td class="cart-tble-item cart-item-price"><?php echo $column_price; ?></td>
                                <td class="cart-tble-item cart-item-total"><?php echo $column_total; ?></td>
                                <td class="cart-tble-item cart-item-remoo"></td>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($products as $product) { ?>
                                <tr>
                                    <td class="cart-tble-item cart-item-img"><?php if ($product['thumb']) { ?>
                                            <a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-thumbnail" /></a>
                                        <?php } ?>
                                    </td>
                                    <td class="cart-tble-item cart-item-name"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
                                    ...
                                    <td class="cart-tble-item cart-item-qua">
                                    ...
                                    <td class="cart-tble-item cart-item-price"><?php echo $product['price']; ?></td>
                                    <td class="cart-tble-item cart-item-total"><?php echo $product['total']; ?></td>
                                    <td class="cart-tble-item cart-item-remoo"><button type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger" onclick="cart.remove('<?php echo $product['key']; ?>');"><i class="fa fa-times-circle"></i></button></td>
                                </tr>
                            <?php } ?>
                        ...
                        <div class="mobile-cart-inner">
                            ...
                            <?php foreach ($products as $product) { ?>
                                <div class='cart-item-mobile'>
                                    <div class="cart-tble-item cart-item-img"><?php if ($product['thumb']) { ?>
                                            <a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-thumbnail" /></a>
                                        <?php } ?>
                                    </div>
                                    <div class="cart-tble-item cart-item-name"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
                                        <?php if (!$product['stock']) { ?>
                                            <span class="text-danger">***</span>
                                        <?php } ?>
                                        <?php if ($product['option']) { ?>
                                        ...
                                        <div class="oprions-cart-mobile">
                                            <div class="cart-tble-item cart-item-qua">
                                        <div class="quanty-box" >
                                            <div class='minus'>-</div>
                                            <input type="text" class='quantity-input' name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" class="form-control" />
                                            <div class='plus'>+</div>
                                    ...
                                    <div class="cart-tble-item cart-item-price"><?php echo $product['price']; ?></div>
                                        </div>
                                    </div>
                                    <!--<td class="text-left"><?php echo $product['model']; ?></td>-->
                                    
                                    <div class="cart-tble-item cart-item-remoo"><button type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger" onclick="cart.remove('<?php echo $product['key']; ?>');"><i class="fa fa-times-circle"></i></button></div>
                                </div>
                            <?php } ?>
                        </div>
                        ...
                        <div class="totals-mobile">
                            <?php foreach ($totals as $total) { ?>
                                <div class="total-item">
                                    <div class="text-right"><strong><?php echo $total['title']; ?>:</strong></div>
                                    <div class="text-right"><?php echo $total['text']; ?></div>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
                    ...
                    <?php if ($text_agree) { ?>
                        <div class="buttons">
                            <div class="text-center">
                                ...
                                <br />
                                <br />
                                <input type="button" value="<?php echo $button_order; ?>" id="button-order" data-loading-text="<?php echo $text_loading; ?>" class="main-btn" />
                            </div>
